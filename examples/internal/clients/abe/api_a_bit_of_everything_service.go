 ...
 * @param optional nil or *ABitOfEverythingServiceCheckGetQueryParamsOpts - Optional Parameters:
     ...
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of the map type. The query form is map_name[key]&#x3D; value,e. g: If the map name is Age, the key type is string, and the value type is integer, the query parameter is expressed as Age[\&quot;bob\&quot;]&#x3D;18
     * @param "MappedStringValue" (optional.String) -  This is a request variable of the map type. The query form is map_name[key]&#x3D; value,e. g: If the map name is Age, the key type is string, and the value type is integer, the query parameter is expressed as Age[\&quot;bob\&quot;]&#x3D;18
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of the map type. The query form is map_name[key]&#x3D; value,e. g: If the map name is Age, the key type is string, and the value type is integer, the query parameter is expressed as Age[\&quot;bob\&quot;]&#x3D;18
