 ...
 * @param optional nil or *ABitOfEverythingServiceCheckGetQueryParamsOpts - Optional Parameters:
     ...
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is map_value[string][string][string][string][string]&#x3D;vaule,string of map_value[string][string][string][string][string] is the type of key and the value type is
     * @param "MappedStringValue" (optional.String) -  This is a request variable of map type,The query form is mapped_string_value[string][string][string][string][string]&#x3D;vaule,string of mapped_string_value[string][string][string][string][string] is the type of key and the value type is string
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is mapped_nested_value[string][string][string][string][string]&#x3D;vaule,string of mapped_nested_value[string][string][string][string][string] is the type of key and the value type is
 ...
 * @param optional nil or *ABitOfEverythingServiceCheckNestedEnumGetQueryParamsOpts - Optional Parameters:
     ...
     * @param "OneofEmpty" (optional.Interface of map[string]string) -
     * @param "OneofString" (optional.String) -
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is map_value[string][string][string][string][string][string]&#x3D;vaule,string of map_value[string][string][string][string][string][string] is the type of key and the value type is
     * @param "MappedStringValue" (optional.String) -  This is a request variable of map type,The query form is mapped_string_value[string][string][string][string][string][string]&#x3D;vaule,string of mapped_string_value[string][string][string][string][string][string] is the type of key and the value type is string
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is mapped_nested_value[string][string][string][string][string][string]&#x3D;vaule,string of mapped_nested_value[string][string][string][string][string][string] is the type of key and the value type is
     * @param "NonConventionalNameValue" (optional.String) -
     * @param "TimestampValue" (optional.Time) -
     * @param "RepeatedEnumValue" (optional.Interface of []string) -  repeated enum value. it is comma-separated in query   - ZERO: ZERO means 0  - ONE: ONE means 1
     * @param "RepeatedEnumAnnotation" (optional.Interface of []string) -  Repeated numeric enum title  Repeated numeric enum description.   - ZERO: ZERO means 0  - ONE: ONE means 1
 ...
 * @param optional nil or *ABitOfEverythingServiceCheckPostQueryParamsOpts - Optional Parameters:
     ...
     * @param "OneofEmpty" (optional.Interface of map[string]string) -
     * @param "OneofString" (optional.String) -
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is map_value[string][string][string][string][string][string][string]&#x3D;vaule,string of map_value[string][string][string][string][string][string][string] is the type of key and the value type is
     * @param "MappedStringValue" (optional.String) -  This is a request variable of map type,The query form is mapped_string_value[string][string][string][string][string][string][string]&#x3D;vaule,string of mapped_string_value[string][string][string][string][string][string][string] is the type of key and the value type is string
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is mapped_nested_value[string][string][string][string][string][string][string]&#x3D;vaule,string of mapped_nested_value[string][string][string][string][string][string][string] is the type of key and the value type is
     * @param "NonConventionalNameValue" (optional.String) -
     * @param "TimestampValue" (optional.Time) -
     * @param "RepeatedEnumValue" (optional.Interface of []string) -  repeated enum value. it is comma-separated in query   - ZERO: ZERO means 0  - ONE: ONE means 1
     * @param "RepeatedEnumAnnotation" (optional.Interface of []string) -  Repeated numeric enum title  Repeated numeric enum description.   - ZERO: ZERO means 0  - ONE: ONE means 1
 ...
 * @param optional nil or *ABitOfEverythingServiceCreateOpts - Optional Parameters:
     ...
     * @param "OneofEmpty" (optional.Interface of map[string]string) -
     * @param "OneofString" (optional.String) -
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is map_value[string]&#x3D;vaule,string of map_value[string] is the type of key and the value type is
     * @param "MappedStringValue" (optional.String) -  This is a request variable of map type,The query form is mapped_string_value[string]&#x3D;vaule,string of mapped_string_value[string] is the type of key and the value type is string
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is mapped_nested_value[string]&#x3D;vaule,string of mapped_nested_value[string] is the type of key and the value type is
     * @param "TimestampValue" (optional.Time) -
     * @param "RepeatedEnumValue" (optional.Interface of []string) -  repeated enum value. it is comma-separated in query   - ZERO: ZERO means 0  - ONE: ONE means 1
     * @param "RepeatedEnumAnnotation" (optional.Interface of []string) -  Repeated numeric enum title  Repeated numeric enum description.   - ZERO: ZERO means 0  - ONE: ONE means 1
     * @param "RepeatedStringAnnotation" (optional.Interface of []string) -  Repeated string title  Repeated string description.
 ...
 * @param optional nil or *ABitOfEverythingServiceCustomOpts - Optional Parameters:
     ...
     * @param "OneofEmpty" (optional.Interface of map[string]string) -
     * @param "OneofString" (optional.String) -
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is map_value[string][string]&#x3D;vaule,string of map_value[string][string] is the type of key and the value type is
     * @param "MappedStringValue" (optional.String) -  This is a request variable of map type,The query form is mapped_string_value[string][string]&#x3D;vaule,string of mapped_string_value[string][string] is the type of key and the value type is string
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is mapped_nested_value[string][string]&#x3D;vaule,string of mapped_nested_value[string][string] is the type of key and the value type is
     * @param "NonConventionalNameValue" (optional.String) -
     * @param "TimestampValue" (optional.Time) -
     * @param "RepeatedEnumValue" (optional.Interface of []string) -  repeated enum value. it is comma-separated in query   - ZERO: ZERO means 0  - ONE: ONE means 1
     * @param "RepeatedEnumAnnotation" (optional.Interface of []string) -  Repeated numeric enum title  Repeated numeric enum description.   - ZERO: ZERO means 0  - ONE: ONE means 1
 ...
 * @param optional nil or *ABitOfEverythingServiceCustomOptionsRequestOpts - Optional Parameters:
     ...
     * @param "OneofEmpty" (optional.Interface of map[string]string) -
     * @param "OneofString" (optional.String) -
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is map_value[string][string][string][string][string][string][string][string][string]&#x3D;vaule,string of map_value[string][string][string][string][string][string][string][string][string] is the type of key and the value type is
     * @param "MappedStringValue" (optional.String) -  This is a request variable of map type,The query form is mapped_string_value[string][string][string][string][string][string][string][string][string]&#x3D;vaule,string of mapped_string_value[string][string][string][string][string][string][string][string][string] is the type of key and the value type is string
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is mapped_nested_value[string][string][string][string][string][string][string][string][string]&#x3D;vaule,string of mapped_nested_value[string][string][string][string][string][string][string][string][string] is the type of key and the value type is
     * @param "NonConventionalNameValue" (optional.String) -
     * @param "TimestampValue" (optional.Time) -
     * @param "RepeatedEnumValue" (optional.Interface of []string) -  repeated enum value. it is comma-separated in query   - ZERO: ZERO means 0  - ONE: ONE means 1
     * @param "RepeatedEnumAnnotation" (optional.Interface of []string) -  Repeated numeric enum title  Repeated numeric enum description.   - ZERO: ZERO means 0  - ONE: ONE means 1
 ...
 * @param optional nil or *ABitOfEverythingServiceDoubleColonOpts - Optional Parameters:
     ...
     * @param "OneofEmpty" (optional.Interface of map[string]string) -
     * @param "OneofString" (optional.String) -
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is map_value[string][string][string]&#x3D;vaule,string of map_value[string][string][string] is the type of key and the value type is
     * @param "MappedStringValue" (optional.String) -  This is a request variable of map type,The query form is mapped_string_value[string][string][string]&#x3D;vaule,string of mapped_string_value[string][string][string] is the type of key and the value type is string
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is mapped_nested_value[string][string][string]&#x3D;vaule,string of mapped_nested_value[string][string][string] is the type of key and the value type is
     * @param "NonConventionalNameValue" (optional.String) -
     * @param "TimestampValue" (optional.Time) -
     * @param "RepeatedEnumValue" (optional.Interface of []string) -  repeated enum value. it is comma-separated in query   - ZERO: ZERO means 0  - ONE: ONE means 1
     * @param "RepeatedEnumAnnotation" (optional.Interface of []string) -  Repeated numeric enum title  Repeated numeric enum description.   - ZERO: ZERO means 0  - ONE: ONE means 1
 ...
 * @param optional nil or *ABitOfEverythingServiceExistsOpts - Optional Parameters:
     ...
     * @param "OneofEmpty" (optional.Interface of map[string]string) -
     * @param "OneofString" (optional.String) -
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is map_value[string][string][string][string][string][string][string][string]&#x3D;vaule,string of map_value[string][string][string][string][string][string][string][string] is the type of key and the value type is
     * @param "MappedStringValue" (optional.String) -  This is a request variable of map type,The query form is mapped_string_value[string][string][string][string][string][string][string][string]&#x3D;vaule,string of mapped_string_value[string][string][string][string][string][string][string][string] is the type of key and the value type is string
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is mapped_nested_value[string][string][string][string][string][string][string][string]&#x3D;vaule,string of mapped_nested_value[string][string][string][string][string][string][string][string] is the type of key and the value type is
     * @param "NonConventionalNameValue" (optional.String) -
     * @param "TimestampValue" (optional.Time) -
     * @param "RepeatedEnumValue" (optional.Interface of []string) -  repeated enum value. it is comma-separated in query   - ZERO: ZERO means 0  - ONE: ONE means 1
     * @param "RepeatedEnumAnnotation" (optional.Interface of []string) -  Repeated numeric enum title  Repeated numeric enum description.   - ZERO: ZERO means 0  - ONE: ONE means 1
 ...
 * @param optional nil or *ABitOfEverythingServiceGetQueryOpts - Optional Parameters:
     ...
     * @param "OneofEmpty" (optional.Interface of map[string]string) -
     * @param "OneofString" (optional.String) -
     * @param "MapValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is map_value[string][string][string][string]&#x3D;vaule,string of map_value[string][string][string][string] is the type of key and the value type is
     * @param "MappedStringValue" (optional.String) -  This is a request variable of map type,The query form is mapped_string_value[string][string][string][string]&#x3D;vaule,string of mapped_string_value[string][string][string][string] is the type of key and the value type is string
     * @param "MappedNestedValue" (optional.Interface of interface{}) -  This is a request variable of map type,The query form is mapped_nested_value[string][string][string][string]&#x3D;vaule,string of mapped_nested_value[string][string][string][string] is the type of key and the value type is
     * @param "NonConventionalNameValue" (optional.String) -
     * @param "TimestampValue" (optional.Time) -
     * @param "RepeatedEnumValue" (optional.Interface of []string) -  repeated enum value. it is comma-separated in query   - ZERO: ZERO means 0  - ONE: ONE means 1
     * @param "RepeatedEnumAnnotation" (optional.Interface of []string) -  Repeated numeric enum title  Repeated numeric enum description.   - ZERO: ZERO means 0  - ONE: ONE means 1
